...
class PWI4Status:
    ...
    def __init__(self, status_dict):
        ...
        self.mount.axis0.rms_error_arcsec = self.get_float(
        ...
        self.mount.axis1.position_timestamp_str = self.get_string(
            "mount.axis1.position_timestamp"
        )  # Added in 4.0.9 beta 2
